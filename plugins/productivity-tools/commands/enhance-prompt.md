...
description: Enhance prompt with full repository context and codebase analysis
---
...
```
/enhance-prompt [prompt-to-enhance]
```

## Parameters

- **prompt-to-enhance** (required): The basic prompt you want to enhance with repository-specific context and analysis
...
# Output: Enhanced prompt with repository's existing auth patterns, preferred libraries, directory structure, and testing requirements

# Example 2: Bug fix
/enhance-prompt "fix the login issue"
# Output: Enhanced prompt with reproduction steps, relevant error logs, existing test patterns, and regression testing requirements

# Example 3: Code generation
/enhance-prompt "create a new API endpoint"
# Output: Enhanced prompt with existing API patterns, validation approaches, documentation requirements, and integration points
```
