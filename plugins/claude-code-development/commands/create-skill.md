---
description: Create a new Claude Code Skill using the working-with-claude-code skill
...
This command helps you create a new Claude Code Skill using the official documentation from the working-with-claude-code skill.
...
Use the working-with-claude-code skill to understand how to create Skills properly, then create the Skill directory structure and files.

The process should be:
1. Use the working-with-claude-code skill to get Skill creation guidance
