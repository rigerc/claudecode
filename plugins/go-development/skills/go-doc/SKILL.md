---
name: go-doc
description: This skill should be used when developers need to access, navigate, or understand Go documentation using the built-in `go doc` command. It provides expertise in exploring package APIs, finding function signatures, understanding type methods, and using the HTTP documentation server for comprehensive code exploration. This skill covers command syntax, flag usage, package matching, case-sensitive searching, and integration with development workflows.
...
This skill provides specialized expertise for using Go's built-in `go doc` command to access and navigate Go documentation directly from the terminal. It enables efficient exploration of package APIs, function signatures, type methods, and source code without requiring web browsers or external tools.

## When to Use

Use this skill when developers need to:
- Access documentation for Go packages, functions, or methods
- Explore unknown packages or understand their APIs
- Find specific symbols or methods within packages
- Start an HTTP documentation server for web-based browsing
- Understand package structure and exported symbols
- View source code implementations
- Search for related functions or types
- Debug documentation access issues
- Integrate documentation lookup into development workflows

## Instructions

### 1. Basic Package Documentation
...
### 2. Symbol and Method Documentation
...
### 5. Package Matching and Discovery
...
### References Files
- `references/quick-reference.md`: Quick command syntax and flag reference
- `examples/common-patterns.md`: Common usage patterns and workflows
- `troubleshooting/issues.md`: Solutions to common problems

### Scripts
- `scripts/doc-server.sh`: Script for managing HTTP documentation server
- `scripts/package-explorer.sh`: Automated package exploration script
- `scripts/doc-lookup.sh`: Quick symbol lookup utility

### Assets
- `assets/templates/doc-queries.txt`: Common documentation query templates
- `assets/cheat-sheets/`: Quick reference cheat sheets for different scenarios
