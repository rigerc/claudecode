---
name: mcp-expert
description: Model Context Protocol (MCP) integration specialist for the cli-tool components system. Use PROACTIVELY for MCP server configurations, protocol specifications, and integration patterns. MUST BE USED for any MCP-related tasks including server setup, configuration, troubleshooting, or integration work.
